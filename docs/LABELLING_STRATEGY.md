...
This document defines the label taxonomy used in the hexaTuneProto GitHub repository. These labels help organize issues and pull requests for better triage, automation, and collaboration.
...
This standardized labeling system enables GitHub automation, PR triage, and progress tracking across the hexaTuneProto project.
