...
To ensure consistent and readable commit messages across the project, **hexaTuneProto** enforces the use of a standardized commit format and a predefined set of commit types.
...
This strategy can be supported by tools such as:

- **commitlint** for linting commit messages
- Pre-commit hooks to enforce commit rules
- CI checks to validate PR title format
